...
<form action="index_pagination.php" method="get"> <!-- todo: ekhon index page er moddhei Employees Category er ekta drop-down list korte hobe. Pashapashi ekta search box/item korte hobe ejonno je drop-down list er je Employees Category-ta select kore search korbo ta shei Employees Category related onnanno information-gulo show korbe. -->
Employees Category:
...
<?php
	...
	if($total_pages > 1)
	{
		...
		for ($page = 1; $page <= $total_pages; $page++) 
		{
			...
			{
	?>
				<a href="index_pagination.php?offset=<?php echo $offset; ?>&employees_category=<?php echo $_GET['employees_category']; ?>"> 
					<?php echo $page; ?>
				</a>
	<?php
			}
			...
			{
	?>
				<a href="index_pagination.php?offset=<?php echo $offset; ?>"> 
					<?php echo $page; ?>
				</a>
	<?php
			}	
